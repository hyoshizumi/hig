...
export default class HIGNodeList {
  constructor(listItems) {
    ...
    this.listItems = new Map(Object.values(listItems).map(spec => [spec.type, spec]));
  ...
  insertBefore(instance, insertBeforeIndex) {
    ...
    const onAdd = this.listItems.get(instance.constructor).onAdd;
  ...
  createElement(ElementConstructor, props) {
    const type = this.listItems.get(ElementConstructor).type;
    const constructor = this.listItems.get(ElementConstructor).HIGConstructor;
